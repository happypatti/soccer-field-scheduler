  ...
  if (isLoading) {
    return (
      <div className="space-y-8">
        {/* Header Skeleton */}
        <div className="relative overflow-hidden rounded-2xl bg-gradient-to-r from-green-600 to-emerald-600 p-8 md:p-12">
        ...
        <div className="relative z-10">
          <div className="flex items-center gap-3 mb-4">
            ...
            <div>
              ...
              <p className="text-green-100">Select a city to view available fields</p>
            </div>
          </div>
